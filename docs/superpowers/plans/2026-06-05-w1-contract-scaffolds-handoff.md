...
Superseded by PR #115, merged to `main` as `8e830e5 [codex] Add Wave 1 contract scaffolds to main (#115)`. Current `main` is now `00146f8 [codex] Add Agent Workbench v2 routes (#139)`.
